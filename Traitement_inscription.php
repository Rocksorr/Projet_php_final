<?php 
	...
	if ($_POST['mot_de_passe'] <> $_POST['mot_de_passe_confirmation']){ // Si le mot de passe rentré n'est pas le même que celui confirmé
		...
		include("bouton_connexion_inscription.html"); // On lui demande de se connecter
